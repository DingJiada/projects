...
//    MyConllectionView *vc = [[MyConllectionView alloc] init];
...
//    viewController.view.backgroundColor = [UIColor whiteColor];
    //push一个viewController到栈底
//    [self.nv pushViewController:viewController animated:YES];
//
    //self.nv.view.hidden = true;
    //设置window窗体的根view为UINavigationController
